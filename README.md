...
**Old repository:** https://github.com/clouddrove/terraform-azure-firewall


The module has been permanently migrated to the **terraform-az-modules** organization:

**➡️ New home:** https://github.com/terraform-az-modules/terraform-azurerm-firewall
...
```hcl
module "example" {
   source      = "terraform-az-modules/firewall/azurerm"
}
```
